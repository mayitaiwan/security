...
<script type="text/javascript"
	src="${ctxpath}/js/permission/newPermissionInfo.js"></script>
<body>
	<form id="permissionForm" name="permissionForm"
		action="${ctxpath}/permission/addPermission"
		method="post">
		<input type="hidden" id="pid" name="pid"
			value="${pid}" />
		<div style="height: 22px; background: #D6E2F3; border: 0px solid red;">新增资源</div>
