...
<body>
	<form id="userForm" name="userForm"
		action="${ctxpath}/user/addUser" method="post">
		<table id="tableLayout"
			...
			<tr style="height: 32px; border: 0px solid red">
				<td>用户账号</td>
				<td><input id="userAccount" type='text' name="userAccount" /></td>
				<td>用户姓名</td>
			...
			<tr style="height: 32px; border: 0px solid red">
				<td>用户描述</td>
				<td colspan="3">
					<textarea id="userDesc" name="userDesc" rows="2" cols="20" style="width:300px;height:50px;"></textarea>
				</td>
			</tr>
			<tr style="height: 32px; border: 0px solid red">
				<td colspan="4">
